...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Bebas Laboratorium - {{ $nama_peminjam }}</title>
    <style>
...
<body>
        ...
        <tr>
            <td style="width:120px; text-align:center; vertical-align:middle;">
                ...
                @if(file_exists($logoPath))
                    <img src="{{ $logoPath }}" alt="Logo UIN" style="width:100px; height:100px; object-fit:contain;">
                @else
                    <div style="width:100px; height:100px; border:1.5px solid #000; font-size:7pt; text-align:center;">LOGO<br>UIN</div>
                @endif
            </td>
    ...
    <table class="data-mhs">
        <tr><td class="label">Nama</td><td class="sep">:</td><td>{{ $nama_peminjam }}</td></tr>
        <tr><td class="label">NIM</td><td class="sep">:</td><td>{{ $nim_peminjam }}</td></tr>
    ...
    <table style="width:100%; margin-top:10px; border-collapse:collapse;">
        <tr>
            ...
            <td style="width:44%; text-align:center; line-height:1.8;">
                Banda Aceh, {{ \Carbon\Carbon::parse($tanggal_terbit)->translatedFormat('d F Y') }}<br>
